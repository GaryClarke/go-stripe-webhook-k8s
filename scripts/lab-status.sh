...
API_URL="${ROSA_API_URL:-https://api.gc-rosa-lab.bd91.p1.openshiftapps.com:6443}"
ROUTE_HOST="${ROSA_ROUTE_HOST:-go-stripe-webhook-k8s-go-stripe-webhook.apps.gc-rosa-lab.bd91.p1.openshiftapps.com}"
