...
- **Build order** - Branch-by-branch plan ([§5](PROJECT_KNOWLEDGE.md#5-build-order-branches)); quick index: [branches/README.md](branches/README.md)
...
- `branches/` - Per-branch decision logs and summaries ([index](branches/README.md))
