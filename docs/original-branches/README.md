...
These files are the **original Lambda / integration-engine** branch log. Paths here are **`docs/original-branches/NN-*.md`**. Branch **numbers match historical git branch names** (e.g. `7-queue-abstraction`, `8-queue-from-config`). The **canonical roadmap** for this era is **[PROJECT_KNOWLEDGE.md §5](../PROJECT_KNOWLEDGE.md#5-build-order-branches)**.

For the **Kubernetes / HTTP service** track, see **[docs/branches/README.md](../branches/README.md)**.
