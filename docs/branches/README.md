...
| `14-structured-logging` | [14-structured-logging.md](14-structured-logging.md) | **Milestone 6** (done): JSON **`slog`**, **`RequestLog`**, **`request_id`**, **`logmsg`** contract; Phase 4 **Recover** polish deferred |
