...
| `17-kafka-outbox` | [17-kafka-outbox.md](17-kafka-outbox.md) | **Milestone 9** (in progress): Redpanda locally, transactional **outbox**, **`accepted`** ledger, publisher + **`cmd/worker`** |
